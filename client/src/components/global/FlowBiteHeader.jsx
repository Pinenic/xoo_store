  ...
  return (
    <>
      <Navbar fluid className="sticky top-0 z-50 bg-white">
        ...
        {profile ? (
          <>
            <div className="flex gap-4 items-center md:order-2">
              <Link
                to="/cart"
                className="flex  gap-2 text-gray-600 rounded-full p-[0.6em] hover:bg-gray-600/10"
              >
                <ShoppingCart />
              ...
              >
                ...
                <DropdownItem>
                  <Link to="/store/dashboard" className="w-full h-full text-left">
                    My Dashboard
                  </Link>
                </DropdownItem>
                <DropdownDivider />
          ...
          <>
            <div className=" flex items-center md:order-2">
              <Link
                to="/cart"
                className="text-gray-600 rounded-full p-[0.6em] hover:bg-gray-600/10"
              >
                <ShoppingCart />
              </Link>
              <Button>
        ...
        <NavbarCollapse>
          <NavbarLink href="/marketplace">Marketplace</NavbarLink>
